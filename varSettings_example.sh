...
testGroups=( N2 N2 ) # this is the biological group that you wish to test for contrasts (it must have the same lenght as the number of samples)
...
genomefile=/home/ubelix/izb/semple/genomeVer/ws260/sequence/c_elegans.PRJNA13758.WS260.genomic.fa  # on ubelix
